...
class ClassRoomsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create class_room" do
    assert_difference('ClassRoom.count') do
      post class_rooms_url, params: { class_room: { Cl_date: @class_room.Cl_date, Cl_no: @class_room.Cl_no, Strength: @class_room.Strength, section_id: @class_room.section_id } }
    end
  ...
  test "should update class_room" do
    patch class_room_url(@class_room), params: { class_room: { Cl_date: @class_room.Cl_date, Cl_no: @class_room.Cl_no, Strength: @class_room.Strength, section_id: @class_room.section_id } }
