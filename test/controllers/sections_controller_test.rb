...
class SectionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create section" do
    assert_difference('Section.count') do
      post sections_url, params: { section: { Sec_no: @section.Sec_no, Strength: @section.Strength } }
    end
  ...
  test "should update section" do
    patch section_url(@section), params: { section: { Sec_no: @section.Sec_no, Strength: @section.Strength } }
